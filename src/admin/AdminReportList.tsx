...
const AdminReportList = ({ userData, refetch }: AdminReportListProps) => {
    ...
    const filteredData = userData.reportList.article_reports.sort((a, b) => a.id - b.id);
    ...
    return (
        <>
            <div className="max-w-[1580px] w-full p-4">
                <h1 className="text-xl font-point mb-4">게시글 신고내역 목록</h1>
