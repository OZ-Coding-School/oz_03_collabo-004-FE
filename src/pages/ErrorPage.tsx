...
const ErrorPage = () => {
    ...
    return (
        <>
            <Header />
            <div className="dark:bg-gray-800 flex flex-col w-screen justify-center items-center min-h-screen font-point text-2xl">
                <img className="dark:bg-slate-500 dark:p-2 dark:rounded-sm mb-10" src="/img/hunsu_logo_dark.png"></img>
